...
exports.messageTypeFields = exports.messageFields = exports.mediaTypes = void 0;
const MessageFunctions_1 = require("./MessageFunctions");
exports.mediaTypes = ['image', 'video', 'audio', 'sticker', 'document'];
let currencies = require('currency-codes/data');
currencies = currencies.map(({ code, currency }) => ({
    name: `${code} - ${currency}`,
    value: code,
}));
exports.messageFields = [
    {
        ...
        routing: {
            send: {
                preSend: [MessageFunctions_1.setType],
            },
        },
        displayOptions: {
            show: {
    ...
    },
    {
        ...
        routing: {
            send: {
                type: 'body',
                preSend: [MessageFunctions_1.cleanPhoneNumber],
            },
        },
        displayOptions: {
            show: {
...
exports.messageTypeFields = [
    ...
    },
    {
        ...
        displayOptions: {
            show: {
                operation: ['send'],
                messageType: exports.mediaTypes,
    ...
    },
    {
        ...
        routing: {
            send: {
                preSend: [MessageFunctions_1.mediaUploadFromItem],
            },
        },
    },
    {
    ...
    },
    {
        ...
        routing: {
            send: {
                type: 'body',
                preSend: [MessageFunctions_1.templateInfo],
            },
        },
    },
    {
        ...
        routing: {
            send: {
                preSend: [MessageFunctions_1.componentsRequest],
            },
        },
        options: [
            {
...
//# sourceMappingURL=MessagesDescription.js.map